...
const Services = () => {
  return (
    <Wrapper className="py-40 md:py-60 flex flex-col items-start justify-center text-center max-w-screen-5xl md:px-20 xl:px-32">
      ...
      <p className=" font-inter text-lg text-[#A3A3A3] max-w-[60rem] mt-4 text-start">
        As a dedicated Web App development agency, we harness the full potential
        of modern technologies like react to build responsive and functional web
        applications that set trends in the digital landscape
      </p>
